...
function setup() {
    ...
    let p2 = createP("https://docs.google.com/forms/d/e/1FAIpQLSeDrUGMAHCNK_nFrrIXMHW1OYE167z4Jjkmf4FZZ7fPphHB2w/viewform?usp=header");
    p2.position(5, height + 40);
    setupVersus();
...
function draw() {
    ...
    // if (currentState == State.VERSUS) countPressesUnfair(true);
